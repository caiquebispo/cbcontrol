    ...
    <x-aside>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li x-data="{ open: false }">
                ...
                <button type="button" x-on:click="open = ! open" class="flex items-center w-full p-2 text-gray-500 text-sm transition duration-75 rounded-lg group hover:bg-gray-950 hover:text-gray-200 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-{{$key_menu}}" data-collapse-toggle="dropdown-{{$key_menu}}">
