...
<body class="font-sans antialiased">
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <div class="w-full content-info-compan flex flex-col items-center">
                ...
                <p
                    class="w-full bg-gray-100 rounded-lg p-2 text-md font-semibold text-gray-800 text-center uppercase my-3">
            ...
            <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                ...
                <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
                    Essa é a nova visualização da plataforma. Estamos sempre pensando na sua experiência em primeiro
                    lugar.
                </p>
            </div>
        </div>
    ...
    < {{-- livewire --}} @livewire('livewire-ui-modal') @livewireScripts <!-- Focus plugin -->
