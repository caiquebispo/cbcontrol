<x-app-layout>
    ...
    <div class="mt-28 flex justify-end">
        ...
        <div class="grid md:grid-cols-4 gap-3 md:gap-6 mt-10">
           <x-indicators.index :name="'Receita'" />
           <x-indicators.index :name="'Vendas'"/>
           <x-indicators.index :name="'Cancelamento'"/>
           <x-indicators.index :name="'Visitas na Pagina'"/>
