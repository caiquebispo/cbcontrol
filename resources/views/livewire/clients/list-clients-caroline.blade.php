        ...
        <x-table.content-table>
            ...
            <x-table>
                <x-table.thead>
                    ...
                    <x-table.th class="text-center" wire:click.prevent="sortBy('number_phone')" :sortable="true"
                        :direction="$sortDirection">TELEFONE</x-table.th>
                    <x-table.th class="text-center" wire:click.prevent="sortBy('value')" :sortable="true"
                        :direction="$sortDirection">VALOR</x-table.th>
                    <x-table.th class="text-center" wire:click.prevent="sortBy('local')" :sortable="true"
                        :direction="$sortDirection">LOCAL</x-table.th>
                    <x-table.th class="text-center" wire:click.prevent="sortBy('payment_method')" :sortable="true"
                        :direction="$sortDirection">PAGAMENTO</x-table.th>
                    <x-table.th class="text-center" wire:click.prevent="sortBy('delivery')" :sortable="true"
                        :direction="$sortDirection">ENTREGA</x-table.th>
                ...
                <x-table.tbody>
                    @foreach ($clients as $client)
                        <x-table.tr>
                            ...
                            <x-table.th class="text-center">R$
                                {{ number_format($client->value, 2, ',', '.') }}</x-table.th>
                            ...
                            <x-table.th class="flex  justify-end">
                                <livewire:clients.update-caroline :client="$client"
