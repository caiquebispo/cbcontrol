<div class="p-4">
    ...
    <div class="my-6">
        <div class="grid grid-cols-1 gap-4 items-center mb-4">
            <livewire:box-front.register-client />
        </div>
        <div class="grid grid-cols-2 gap-4 items-center">
            <div>
                <x-select wire:model.defer="client_id" placeholder="Selecione um cliente" :async-data="route('client.getAll')"
                    option-label="full_name" option-value="id" />
            </div>
            <div>
                <x-select wire:model.defer="delivery_man_id" placeholder="Selecione um entregador" :async-data="route('users.getAll')"
